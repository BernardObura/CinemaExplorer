      ...
      <div className="container px-4 sm:px-6">
        ...
        <div className="flex h-16 items-center justify-between lg:hidden">
          ...
          >
            ...
            <h1 className="text-lg font-bold text-foreground">CE</h1>
          </button>
            ...
            {user ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="icon" className="hover:bg-accent hover:text-accent-foreground h-8 w-8">
              ...
              <Button 
                ...
                variant="outline"
                size="sm"
                className="border-netflix-red text-netflix-red hover:bg-netflix-red hover:text-white text-xs px-3"
              >
                Sign In
              </Button>
            )}
              ...
              <DialogContent className="sm:max-w-md mx-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    <Button onClick={handleApiKeySubmit} disabled={!apiKey.trim()} size="sm">
        ...
        <div className="py-3 lg:hidden">
          <div className="flex gap-2">
            ...
            <Button 
              ...
              className="bg-netflix-red hover:bg-netflix-red/90 text-white px-4 text-sm"
              size="sm"
            >
              Search
            </Button>
